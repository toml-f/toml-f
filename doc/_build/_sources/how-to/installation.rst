...
.. image:: https://repology.org/badge/version-for-repo/debian_unstable/toml-f.svg
   :alt: Debian
   :target: https://packages.debian.org/search?keywords=libfortran-toml-dev

TOML Fortran is available in Debian as ``libfortran-toml-dev``. To install on Debian forky (or later versions), use:
